...
#cambiar dominios
wordpress=wordpressequipo45
openfire=openfireequipo45
#cambiar token
token=b27520e1-70af-4f2a-9805-6b9e7ddad59e
#cambiar alumno
alumno=aromoo01
#cambiar ips de los servidores
nginx_principal="10.227.1.10"
nginx_secundario="10.227.1.20"
...
if [[ \"\$local_status\" == \"active\" && \"\$remote_status\" != \"active\" ]]; then
        ...
        echo url=\"https://www.duckdns.org/update?domains=nginxlocal227&token=$token&ip=10.227.1.20\" | curl -k -o /home/ubuntu/duckdns/duck.log -K -
else
    exit 1
fi
