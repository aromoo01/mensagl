...
$_SERVER["HTTP_HOST"] = "wordpressequipo45.duckdns.org";\
$_SERVER["REMOTE_ADDR"] = "wordpressequipo45.duckdns.org";\
$_SERVER["SERVER_ADDR"] = "wordpressequipo45.duckdns.org";\
' /var/www/html/wp-config.php


sudo scp -i clave.pem -o StrictHostKeyChecking=no ubuntu@10.227.1.10:/home/ubuntu/certwordpress/* /home/ubuntu/
